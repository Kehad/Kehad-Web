...
const Home = function () {
  return (
    <div className="flex flex-col mt-0 ">
      <h1 className="text-primary font-Judson mb-4 text-5xl sm:text-5xl md:text-5xl lg:text-7xl">
        Hi.
      </h1>
      ...
      <p className=" font-judson  font-normal  mt-3 mb-3 text-[1.5rem] sm:text-[1.5rem] md:text-[1.5rem] md:text-3xl md:leading-tight lg:text-4xl lg:leading-normal">
