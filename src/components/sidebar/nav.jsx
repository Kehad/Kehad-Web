...
const Nav = function () {
  ...
  return (
    <nav className="">
      <div className="lg:flex flex-col justify-center rounded-7 bg-sup w-max pt-20 pb-20 lg:pr-10 md:pr-6 lg:pl-10 md:pl-6  gap-4 transition transition-all duration-500 border-1 border-sub group hover:flex dark:bg-mainOpacity dark:text-white dark:border-primary dark:border-1 sm:hidden md:block">
