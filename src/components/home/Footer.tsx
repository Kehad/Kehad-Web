...
export default function Footer() {
  return (
    <footer className="w-full border-t border-gray-800/80 mt-12 bg-[#0A0E17]/80 backdrop-blur-md relative z-20">
      <div className="w-full max-w-[1500px] mx-auto px-6 py-8 md:py-0 md:h-24 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
          <div className="flex items-center gap-6">
            <a href="#" className="text-white font-black text-sm tracking-wide hover:text-blue-400 transition cursor-none">Blog</a>
            <a href="#" className="text-white font-black text-sm tracking-wide hover:text-blue-400 transition cursor-none">Newsletter</a>
          </div>
        ...
        <div className="flex items-center gap-5 sm:gap-6">
          <a href="#" className="text-gray-400 hover:text-white transition cursor-none transform hover:scale-110">
