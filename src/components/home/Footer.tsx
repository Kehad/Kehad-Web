    ...
    <footer className="w-full border-t border-gray-200 dark:border-gray-800/80 mt-12 bg-white/80 dark:bg-[#0A0E17]/80 backdrop-blur-md relative z-20">
      <div className="w-full max-w-[1500px] mx-auto px-6 py-8 md:py-0 md:h-24 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0">
        ...
        <div className="flex items-center gap-5 sm:gap-6">
          <a href="https://github.com/Kehad10" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition cursor-pointer transform hover:scale-110">
          ...
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition cursor-pointer transform hover:scale-110">
