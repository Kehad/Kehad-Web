...
export default function ProjectDetail() {
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] text-white overflow-x-hidden selection:bg-blue-500/30">
      
      {/* Navigation */}
      <nav className="fixed top-0 w-full p-4 sm:p-6 z-50 flex justify-between items-center bg-transparent backdrop-blur-sm pointer-events-auto border-b border-white/5">
      ...
      {/* Hero 3D Section */}
      <header className="relative w-full h-[60vh] md:h-[70vh] flex items-end justify-center bg-gradient-to-b from-gray-900 via-[#0B0F19] to-[#0B0F19]">
      ...
      {/* Main Content */}
      <main className="relative z-20 max-w-[1200px] mx-auto px-6 py-12 md:py-20 flex flex-col gap-16">
        
        {/* Header Strings */}
        <div className="flex flex-col gap-6 items-start">
          <h1 className="text-4xl md:text-6xl font-black tracking-tight drop-shadow-lg" style={{ color: project.color }}>
            {project.title}
          </h1>
          <p className="text-xl md:text-3xl font-light text-gray-300 max-w-3xl leading-relaxed">
            {project.tagline}
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="mt-8 flex gap-6">
              <a href="#" className="px-8 py-4 rounded-xl bg-white text-gray-950 font-bold uppercase tracking-widest hover:scale-105 transition-transform flex items-center gap-3">
                Live Site
